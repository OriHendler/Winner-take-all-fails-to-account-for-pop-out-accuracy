...
Popwta=1;
%
correlation_cofarr=[0.05];%correlation between the firing rate of neurons in the same population 
Narr=[50000]; %number of neurons per population
Marr=[8];  %number of distracotrs
qarr=[1.3];
