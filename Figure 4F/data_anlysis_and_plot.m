...
SEM_F=error_values/sqrt(Number_Of_Realizations)
figure(1)
...
saveas(figure(1),'PlotReadoutVSInterCorrlation','fig')
saveas(figure(1),'PlotReadoutVSInterCorrlation','jpg')
saveas(figure(1),'PlotReadoutVSInterCorrlation','tif')