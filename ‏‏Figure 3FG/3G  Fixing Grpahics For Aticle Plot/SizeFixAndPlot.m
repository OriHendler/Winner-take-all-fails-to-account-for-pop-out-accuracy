...
close all
  ...
  fh = openfig('CDFOfScorerN1000.fig');
...
saveas(figure(1),'CDFOfScorerN1000REMAKE','fig')
saveas(figure(1),'CDFOfScorerN1000REMAKE','jpg')
saveas(figure(1),'CDFOfScorerN1000REMAKE','tif')