...
myFolder = 'C:\Users\Ori Hendler\Desktop\עבודה\מעוז\סיכום\Entire Code Generation 23.04\Figure 3B\data_analysis';
...
% hold on
% end
plot(mean_correct_readout_saver_all_realizations_matrix(4:4:104,3),mean_correct_readout_saver_all_realizations_matrix(4:4:104,1),'color',[0,0,1],LineWidth=1.5)
hold on
plot(mean_correct_readout_saver_all_realizations_matrix(3:4:104,3),mean_correct_readout_saver_all_realizations_matrix(3:4:104,1),'color',[0,0,0.85],LineWidth=1.5)
hold on
plot(mean_correct_readout_saver_all_realizations_matrix(2:4:104,3),mean_correct_readout_saver_all_realizations_matrix(2:4:104,1),'color',[0,0,0.7],LineWidth=1.5)
hold on
plot(mean_correct_readout_saver_all_realizations_matrix(1:4:104,3),mean_correct_readout_saver_all_realizations_matrix(1:4:104,1),'color',[0,0,0.5],LineWidth=1.5)
hold on
plot([2:4:98 100],1./[2:4:98 100],'k',LineWidth=1.5)
%%
set(gca, 'TickDir', 'out')
xlabel('Number of Distractors (M)')
ylabel('Readout Accuracy')
title('5000 Neurons per Population')
...
saveas(figure(41),'MchangingN5000meann13var4mu_for_expChanging.jpg','jpg');
saveas(figure(41),'MchangingN5000meann13var4mu_for_expChanging.fig','fig');
saveas(figure(41),'MchangingN5000meann13var4mu_for_expChanging.tif','tif');
