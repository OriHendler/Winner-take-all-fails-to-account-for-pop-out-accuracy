...
% plot([1 1000], [0.5 0.5], 'k'); % Keeps the reference line unchanged
...
saveas(figure(1), 'FIGURE5PannelB_withErrorBars', 'jpg');
saveas(figure(1), 'FIGURE5PannelB_withErrorBars', 'fig');
saveas(figure(1), 'FIGURE5PannelB_withErrorBars', 'tif');
saveas(figure(1), 'FIGURE5PannelB_withErrorBars.pdf');
exportgraphics(figure(1), 'FIGURE5PannelB_withErrorBars.pdf', 'ContentType', 'vector', 'Resolution', 600);
