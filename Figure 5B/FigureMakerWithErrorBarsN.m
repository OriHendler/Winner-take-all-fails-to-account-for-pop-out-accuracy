...
%Load data for plot
load('C:\Users\hendlero\OneDrive\שולחן העבודה\מאמר ראשון מוכן לשליחה\PLOS computational Biology\Peer review A\Figure 4HV2 edited for 2I2AFC\‏‏Network with correlations Hetrogeneous varified codes\data_analysis\POPM10~1.MAT');
...
% for idx = 1:9
%     plot(order_N_axis(idx,:), order_Pc_axis(idx,:), ...
%         'LineWidth', 1.5, 'Color', color_order(idx,:));
%     hold on;
% end
...
saveas(figure(1), 'FIGURE5PannelB_withAnalytical', 'jpg');
saveas(figure(1), 'FIGURE5PannelB_withAnalytical', 'fig');
saveas(figure(1), 'FIGURE5PannelB_withAnalytical', 'tif');
saveas(figure(1), 'FIGURE5PannelB_withAnalytical.pdf');
exportgraphics(figure(1), 'FIGURE5PannelB_withAnalytical.pdf', 'ContentType', 'vector', 'Resolution', 600);
